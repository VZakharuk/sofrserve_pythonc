...
player_image = pygame.image.load("*/Fly.png").convert() # Write the full path to file here
...
#повертає поточну позицію мишки на екрані
    ...
    screen.fill(BLACK)    # command that clean display, and must to be above commands .blit, flip and .draw
